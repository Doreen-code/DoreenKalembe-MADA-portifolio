...
The data contains 15 observations and five variables. I added two more variables that is ear color which is a character variable and waist size which is a numeric variable showing the waist size of each individual plus their individual eye color.
